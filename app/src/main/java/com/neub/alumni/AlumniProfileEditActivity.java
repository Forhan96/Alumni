...
public class AlumniProfileEditActivity extends AppCompatActivity {
    ...
    String nameR, phoneR, emailR, deptR, sessionR, idR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alumni_profile_edit);
        ...
        alumniProfileImage = findViewById(R.id.alumni_image_edit);
        pName = findViewById(R.id.alumni_name_edit);
        pPhone = findViewById(R.id.alumni_phone_edit);
        pDept = findViewById(R.id.alumni_department_edit);
        pSession = findViewById(R.id.alumni_session_edit);
        pId = findViewById(R.id.alumni_id_edit);

        submit = findViewById(R.id.btn_alumni_submit);

        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                updateProfile();
                Intent profile = new Intent(getApplicationContext(), AlumniProfileActivity.class);
                profile.putExtra("Type", type);
                startActivity(profile);
            }
        });
        alumniProfileImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showImageChooser();
            }
        ...
        profileEditRef = database.getReference().child("Users").child("Alumni").child(user.getUid());
...
//                            imageProgressbar.setVisibility(View.GONE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == CHOOSE_IMAGE && resultCode == RESULT_OK && data != null && data.getData() != null){
            ...
            Picasso.get().load(uriProfilePicture).into(alumniProfileImage);
